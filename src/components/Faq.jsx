        ...
        <div className="row">
          ...
          <h3 className="perguntasFaq">Nossos Horarios <FaArrowDown fontSize={17} /></h3>
              <div className="horasTrabalho">
                <p className="d-flex justify-content-between pHorarios"><strong>SEGUNDA-FEIRA</strong> 08H00-17H00</p>
                <p className="d-flex justify-content-between pHorarios"><strong>TERÇA-FEIRA</strong> 08H00-17H00</p>
                <p className="d-flex justify-content-between pHorarios"><strong>QUARTA-FEIRA</strong> 08H00-17H00</p>
                <p className="d-flex justify-content-between pHorarios"><strong>QUINTA-FEIRA</strong> 08H00-17H00</p>
                <p className="d-flex justify-content-between pHorarios"><strong>SEXTA-FEIRA</strong> 08H00-17H00</p>
          ...
          <div className="col-12 col-md-12 col-lg-6">
            ...
            <Accordion defaultActiveKey="0" className="bordaritem">
              <Accordion.Item eventKey="0"> 
                <Accordion.Header className="bg-header"><FiHelpCircle className="iconeFaq" /> <strong >Com que frequência devo fazer a troca de óleo do meu veículo?</strong></Accordion.Header>
              ...
              <Accordion.Item eventKey="1">
                <Accordion.Header  className="bg-header"><FiHelpCircle className="iconeFaq" /><strong>O que devo fazer se meu carro apresentar um barulho estranho?</strong></Accordion.Header>
                <Accordion.Body className="textAliado" >
              ...
              <Accordion.Item eventKey="2">
                <Accordion.Header  className="bg-header"><FiHelpCircle className="iconeFaq" /><strong>Vocês oferecem garantia nos serviços realizados?</strong></Accordion.Header>
                <Accordion.Body className="textAliado">
